...
def save_models(step, g_model_AtoB, g_model_BtoA, output_path='src_simulated/outputs/cyclegan'):
...
def summarize_performance(step, g_model, trainX, name, n_samples=5, output_path='src_simulated/outputs/cyclegan'):
    ...
    for i in range(n_steps):
        ...
        if (i + 1) % (bat_per_epo * 5) == 0:
            save_models(i, g_model_AtoB, g_model_BtoA,
                        output_folder='src_simulated/outputs/cyclegan')
