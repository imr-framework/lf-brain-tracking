...
# Load Data
path_raw_t2 = "Data/Nipah_IRF_data/IRF_3T_NIFTI"
substring_filter = "T2_n100"

def load_nii_volumes_downsampled(path, target_spacing=(2,2,5), add_channel=False, 
                     target_h=70, target_w=70, target_d=14, 
