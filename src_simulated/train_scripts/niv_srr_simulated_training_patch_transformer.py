...
from src_simulated.models.transformer import *
...
def run_retraining(checkpoint_path,
                   ...
                   X_val, y_val, 
                   output_path,
                   model_type=build_3d_transformer_srr,
                   batch_size=32,
    ...
    refined_model = build_or_load_model(model_type, refined_checkpoint_path)
...
if __name__ == "__main__":
    ...
    for loss_denoise, loss_retrain in selected_combinations:
        ...
        # Refinement (2nd pass)
        # Model type training different but taking input of first stage
