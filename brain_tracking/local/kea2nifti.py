...
if __name__ == '__main__':
    ...
    if debug is True:
      ...
      im = nib.load('Niftymic_related/Data/In_vivo/2_avg/circ-shifted/axial.nii.gz')
      data = im.get_fdata()
      plot_anatomy_raw(data)

      # im_axial_reload = nib.load('axial.nii.gz')
      # data = im_axial_reload.get_fdata()
      # plot_anatomy_raw(data)
      #
      # im_sag_reload = nib.load('sag.nii.gz')
      # data = im_sag_reload.get_fdata()
      # plot_anatomy_raw(data)
      #
      #
      # im_cor_reload = nib.load('cor.nii.gz')
      # data = im_cor_reload.get_fdata()
      # plot_anatomy_raw(data)
