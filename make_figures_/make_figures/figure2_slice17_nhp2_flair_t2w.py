"""
Combined Figure 2 panel for FLAIR and T2W at slice 17 for NHP2.
Top row: FLAIR
Bottom row: T2W
Same settings as the combined slice-17/18 layouts, excluding the 1x1x5mm volume.
"""
...
FIGURE_NAME = f"Figure2_slice17_nhp2_flair_t2w_{DATASET_FOLDER}"
...
FLAIR_BASE_FOLDER = os.path.join(
    ...
    DATASET_FOLDER,
    "AFRICAN.GREEN^NA_08112_MR_2018-06-20_095930_MR.BRAIN.WOWCONTRAST_T2.2D.FLAIR_n30__00000",
)
FLAIR_FILE_PREFIX = "AFRICAN.GREEN^NA_08112_MR_2018-06-20_095930_MR.BRAIN.WOWCONTRAST_T2.2D.FLAIR_n30__00000"

T2W_BASE_FOLDER = os.path.join(
    "Data_prospective_study",
    DATASET_FOLDER,
    "AFRICAN.GREEN^NA_08112_MR_2018-06-20_095930_MR.BRAIN.WOWCONTRAST_T2W.TSE_n30__00000",
)
T2W_FILE_PREFIX = "AFRICAN.GREEN^NA_08112_MR_2018-06-20_095930_MR.BRAIN.WOWCONTRAST_T2W.TSE_n30__00000"
...
fig.subplots_adjust(left=0, right=1, bottom=0, top=1, wspace=-0.090, hspace=-0.15)
