"""
Combined Figure 2 panel for FLAIR and T2W at slice 17.
Top row: FLAIR
Bottom row: T2W
Each row keeps the same a/b/c sequence and excludes the 1x1x5mm volume.
"""
...
FIGURE_NAME = f"Figure2_slice17_flair_t2w_{DATASET_FOLDER}"
