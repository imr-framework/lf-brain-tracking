"""
Combined Figure 2 panel for FLAIR and T2W at slice 16 for NHP2.
Top row: FLAIR
Bottom row: T2W
Same settings as the combined slice figures, excluding the 1x1x5mm volume.
"""
...
FIGURE_NAME = f"Figure2_slice16_nhp2_flair_t2w_{DATASET_FOLDER}"
...
fig.subplots_adjust(left=0, right=1, bottom=0, top=1, wspace=-0.0500, hspace=-0.15)
