...
FIGURE_NAME = f"Figure2_slice18t2w_{DATASET_FOLDER}"
...
HIGH_FIELD_FILE = os.path.join(
    BASE_FOLDER,
    "AFRICAN.GREEN NA_08078_MR_2018-06-22_090645_MR.BRAIN.WCONTRAST_T2W.TSE_n30__0000_LFsim_1x1x2mm.npy"
)


PANELS = [

    # High field reference
    {
        "file": HIGH_FIELD_FILE,
        "key": "hf_original",
        "plane": "axial",
        "slice": 19,
...

    {
        "file": os.path.join(
            BASE_FOLDER,
            "AFRICAN.GREEN NA_08078_MR_2018-06-22_090645_MR.BRAIN.WCONTRAST_T2W.TSE_n30__0000_LFsim_1x1x3mm.npy"
        ),
...

    {
        "file": os.path.join(
            BASE_FOLDER,
            "AFRICAN.GREEN NA_08078_MR_2018-06-22_090645_MR.BRAIN.WCONTRAST_T2W.TSE_n30__0000_LFsim_1x1x5mm.npy"
        ),
        "key": "lf_simulated_upsampled",
        "plane": "axial",
        "slice": 7,
...

    {
        "file": os.path.join(
            BASE_FOLDER,
            "AFRICAN.GREEN NA_08078_MR_2018-06-22_090645_MR.BRAIN.WCONTRAST_T2W.TSE_n30__0000_LFsim_1.5x1.5x2mm.npy"
        ),
        "key": "lf_simulated_upsampled",
        "plane": "axial",
        "slice": 19,
...

    {
        "file": os.path.join(
            BASE_FOLDER,
            "AFRICAN.GREEN NA_08078_MR_2018-06-22_090645_MR.BRAIN.WCONTRAST_T2W.TSE_n30__0000_LFsim_2x2x2mm.npy"
        ),
        "key": "lf_simulated_upsampled",
        "plane": "axial",
        "slice": 19,
